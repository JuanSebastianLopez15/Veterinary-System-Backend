...
exports.MedicalHistoryModule = MedicalHistoryModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([medical_history_entity_1.MedicalHistory, prescribed_medication_entity_1.PrescribedMedication, vaccine_entity_1.Vaccine]),
        ...
        exports: [medical_history_service_1.MedicalHistoryService],
    })
